...
const ModernInventoryList = () => {
  ...
  useEffect(() => {
    ...
    if (lastEntityUpdate) {
      ...
      if (entityType === 'INVENTORY' || entityType === 'PRODUCT') {
        console.log('InventoryList: Refetching data due to entity update:', lastEntityUpdate);
        fetchData();
      }
    }
  }, [entityUpdateTrigger]);
      ...
      <Box sx={{ p: { xs: 2, sm: 3 }, backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
        ...
        <Paper elevation={2} sx={{ p: { xs: 1.5, sm: 2 }, mb: 3, borderRadius: '12px' }}>
          <TextField
            fullWidth
            variant="outlined"
            placeholder={isMobile ? "Search inventory..." : "Search by product name, SKU or location..."}
            value={searchTerm}
                ...
                {filteredInventory.map((item) => (
                  <Grid item xs={12} key={item.id}>
                    <Card
                      ...
                      sx={{
                        borderRadius: '12px',
                        borderLeft: `4px solid ${isLowStock(item) ? '#e74c3c' : '#2ecc71'}`
                      }}
                    >
                      <CardContent sx={{ p: 2 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1.5 }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', flex: 1 }}>
                            ...
                            >
                              <InventoryIcon sx={{ color: isLowStock(item) ? '#e74c3c' : '#3a7bd5', fontSize: '1.2rem' }} />
                            </Box>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', my: 2 }}>
                          <IconButton
                            ...
                            sx={{ border: '1px solid rgba(231, 76, 60, 0.3)', mr: 1.5 }}
                          >
                          ...
                          <IconButton
                            ...
                            color="primary"
                            onClick={() => handleUpdateQuantity(item.productId, 1)}
                            sx={{ border: '1px solid rgba(58, 123, 213, 0.3)', ml: 1.5 }}
                          >
                        ...
                        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, justifyContent: 'space-between', alignItems: 'center' }}>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <LocationIcon sx={{ color: 'rgba(58, 123, 213, 0.6)', mr: 0.5, fontSize: '0.9rem' }} />
