          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} md={3}>
              <FormControl fullWidth size={isMobile ? "small" : "medium"}>
                <InputLabel id="transaction-type-label">{isMobile ? "Type" : "Transaction Type"}</InputLabel>
                <Select
                  labelId="transaction-type-label"
                  name="type"
                  value={filters.type}
                  onChange={handleFilterChange}
                  label={isMobile ? "Type" : "Transaction Type"}
                  sx={{ borderRadius: '8px' }}
                >
            ...
            <Grid item xs={6} md={2}>
              <FormControl fullWidth size={isMobile ? "small" : "medium"}>
                <InputLabel id="date-filter-label">{isMobile ? "Date" : "Date Range"}</InputLabel>
                <Select
                  labelId="date-filter-label"
                  name="dateRange"
                  value={dateRange}
                  onChange={(e) => handleDateRangeChange(e.target.value)}
                  label={isMobile ? "Date" : "Date Range"}
                  sx={{ borderRadius: '8px' }}
                >
            ...
            <Grid item xs={12} md={2} sx={{ display: 'flex', alignItems: 'center', justifyContent: { xs: 'center', md: 'flex-end' } }}>
              <Button
                variant="outlined"
                    ...
                    <Card
                      ...
                      sx={{
                        ...
                        borderLeft: `4px solid ${
                          transaction.transactionType === 'SALE' ? '#e74c3c' :
                          transaction.transactionType === 'PURCHASE' ? '#3498db' : '#2ecc71'
                        }`
                      }}
                    >
