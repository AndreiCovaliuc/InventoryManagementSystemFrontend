...
const CompanyRegister = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', backgroundColor: '#f8f9fa', display: 'flex', alignItems: 'center', py: { xs: 2, sm: 4 }, px: { xs: 2, sm: 0 } }}>
      <Container component="main" maxWidth="sm" sx={{ px: { xs: 0, sm: 2 } }}>
        <Paper elevation={3} sx={{ borderRadius: '16px', overflow: 'hidden' }}>
          <Box sx={{
            ...
            <Avatar sx={{ bgcolor: 'rgba(255, 255, 255, 0.2)', width: { xs: 50, sm: 70 }, height: { xs: 50, sm: 70 }, mb: 2 }}>
              <BusinessIcon sx={{ fontSize: { xs: 28, sm: 40 } }} />
            </Avatar>
            <Typography variant={isMobile ? "h5" : "h4"} sx={{ color: 'white', fontWeight: 'bold', textAlign: 'center' }}>
              Register Your Company
            </Typography>
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.8)', mt: 0.5, textAlign: 'center' }}>
